...
<body>
	<div class="navbar navbar-inverse">
		...
		<div class='buttons'>
			...
			<div id="cl2">
				<div class="dropdown">
					<i class="material-icons" id="list" role="button" data-toggle="dropdown" style="font-size:28px;color:red">
						notifications_none
					</i>
					<span class="badge badge-light"><c:out value="${count}"></c:out></span>
				...
				<div>
					 <a href="#" class="btn cl1" style="font-size: 15px; cursor: pointer"
	...
	<div class="content">
		...
		<div id="main" class="container">
			...
			<div class="container-fluid">
				<c:forEach var="st" items="${NotesList}">
					<div class="display">
						<a id="uni" class=btn href="Notesdetails?id=${st.getId()}">${st.getName()}</a>
	...
	<div class="modal fade" id="myModal" role="dialog">
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="btm" action="Notes" method="post">
						Notes Name : <input type="text" name="notesName"
							placeholder="Enter name..."> </br>
						</br> Start Date: <input type="date" name="sDate"
							placeholder="YYYY-MM-DD"> </br>
						</br> End date : <input type="date" name="eDate"
							placeholder="YYYY-MM-DD"> </br>
						</br> Remainder Date: <input type="date" name="rDate"
							placeholder="YYYY-MM-DD"> </br>
						</br> status :<select name="status">
							<option>Started</option>
							<option>Not Started</option>
						</select> </br>
						</br> Tag : <select name="tag">
							<option>Public</option>
							<option>Private</option>
						</select> </br>
						</br> Description : <input type="text" id="des1" name="des"
							placholder="Enter your description......"> </br>
						</br>
						<button class="btn btn-success">Save</button>
					</form>
					<div class="modal-footer">
	...
	<div class="modal fade" id="myModal3" role="dialog">
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="btm" action="editNotes" method="post">
						<p style="display: none;">
							<input type="text" name="Id" id="Nid">
						</p>
						</br>
						</br> Notes Name : <input type="text" name="notesName" id="Nname">
						</br>
						</br> Start Date: <input type="date" name="sDate" id="Nsdate">
						</br>
						</br> End date : <input type="date" name="eDate" id="Nedate"> </br>
						</br> Remainder Date: <input type="date" name="rDate" id="Nrdate">
						</br>
						</br> status :<select name="status" id="Nstatus">
							<option>Started</option>
							<option>Not Started</option>
						</select> </br>
						</br> Tag : <select name="tag" id="Ntag">
							<option>Public</option>
							<option>Private</option>
						</select> </br>
						</br> Description : <input type="text" id="des1" name="des"
	...
	<div class="modal fade" id="myModal4" role="dialog">
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="btm" action="deleteNotes" method="post">
						<p style="display: none;">
							<input type="text" name="ID" id="NId">
						</p>
						</br>
